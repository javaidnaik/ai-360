...
const StartScreen: React.FC<StartScreenProps> = ({ onFilesSelect, onShowGallery, onShowVideoEditor, onShowImageEditor, hasCreations }) => {
            ...
            {isAuthenticated ? (
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <button 
                  ...
                  className="relative inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl cursor-pointer group hover:from-purple-500 hover:to-pink-500 transition-all duration-300 shadow-lg shadow-pink-600/30 hover:shadow-xl hover:shadow-pink-500/40 hover:-translate-y-1 transform"
                >
                  🎨 Edit Images with AI
                  <div className="absolute inset-0 bg-white/20 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                </button>
